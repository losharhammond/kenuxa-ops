...
import {
  ...
  Sparkles, CheckCircle, Play, ChevronRight,
...
export const metadata: Metadata = {
  ...
  description: "One platform connecting businesses, customers, freelancers, job seekers, suppliers, and financial institutions across 54 countries. Register free.",
};
...
const PLATFORM_FEATURES = [
  {
    icon: CreditCard,
    title: "KENUX Wallet",
    desc: "Double-entry ledger wallet for every user. Pay, receive, and earn KENUX — the platform utility currency. Mobile money, card, and bank transfer supported.",
    color: "#FF8B5E",
    badge: "Finance",
  },
  {
    icon: Sparkles,
    title: "AI Economic Copilot",
    desc: "Personalized business insights, market intelligence, supplier matching, job recommendations, and credit advisory — all powered by on-platform data.",
    color: "#8b5cf6",
    badge: "AI",
  },
  {
    ...
    desc: "Every transaction, review, and interaction builds your economic identity. Your KENUXA score is your reputation across the entire network.",
    color: "#10b981",
    badge: "Identity",
  },
  {
    icon: Shield,
    title: "KENUXA ID",
    desc: "Verified digital identity linking businesses, employment, purchases, and financial history. One ID, every economic context.",
    color: "#3b82f6",
    badge: "Security",
  },
  {
    ...
    desc: "Local currencies, local payment rails, local languages. Built for the operational reality of high-growth markets from day one.",
    color: "#f59e0b",
    badge: "Global",
  },
  {
    ...
    desc: "Working capital, invoice financing, BNPL, and equipment finance — connected to banks, MFIs, and fintechs through a single verified API.",
    color: "#ec4899",
    badge: "Credit",
  },
];
...
const HOW_IT_WORKS = [
  { step: "01", title: "Create Your KENUXA ID", desc: "Register in under 2 minutes. One identity for every economic role — customer, business, freelancer, and more.", icon: Users },
  { step: "02", title: "Activate Your Role",     desc: "Switch between roles at any time. Start as a customer, add a business, post as a freelancer — no separate accounts.", icon: Cpu },
  { step: "03", title: "Transact & Build Credit", desc: "Every transaction, review, and interaction builds your KENUXA economic score — your passport to financing.", icon: BarChart3 },
  { step: "04", title: "Grow with the Network",  desc: "Access working capital, AI insights, supplier networks, and premium tools as your economic profile matures.", icon: TrendingUp },
];

const TESTIMONIALS = [
  {
    quote: "KENUXA changed how we manage our whole operation. POS, inventory, CRM — everything in one place. We grew 40% in six months.",
    name: "Ama Owusu",
  ...
  {
    quote: "I got my first working capital loan through KENUXA's financial partner portal. My KENUXA score made the approval process fast and transparent.",
    name: "Kwame Asante",
    role: "Supplier, Kumasi",
    initials: "KA",
    color: "#10b981",
  },
  {
    quote: "As a freelancer, having my work history, reviews, and earnings all in one verified profile means clients trust me immediately. My income doubled.",
    name: "Fatima Ibrahim",
...
const PRICING = [
  {
    ...
    price: "GH₵ 0",
    period: "/month",
    desc: "Personal account — always free",
    featured: false,
    features: [
      "KENUXA ID + Wallet",
      "Shop the marketplace",
      "Apply to jobs",
      "500 KENUX welcome bonus",
      "AI assistant (basic)",
      "Community access",
    ],
    cta: "Start Free",
  ...
  },
  {
    ...
    price: "GH₵ 149",
    period: "/month",
    desc: "Full business operating system",
    featured: true,
    badge: "Most Popular",
    features: [
      "Everything in Free",
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#060810] text-[#f1f5f9] overflow-x-hidden">
      ...
      {/* ── NAV ─────────────────────────────────────────────── */}
      <header className="sticky top-0 z-50 border-b border-white/[0.05] bg-[#060810]/90 backdrop-blur-2xl">
        <div className="max-w-7xl mx-auto px-5 h-[62px] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="w-9 h-9 rounded-[11px] bg-gradient-to-br from-[#FF6524] to-[#F59E0B] flex items-center justify-center text-white font-black text-base shadow-[0_0_24px_rgba(255,101,36,0.5)]">
                K
              </div>
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm">
            {NAV_LINKS.map((l) => (
              <Link key={l.label} href={l.href} className="text-[#4a5578] hover:text-[#f1f5f9] transition-colors font-medium">
                {l.label}
              </Link>
            ))}
          </nav>
          <div className="flex items-center gap-2">
            <Link href="/login" className="hidden sm:flex items-center px-4 py-2 text-sm text-[#4a5578] hover:text-[#f1f5f9] font-medium transition-colors">
              Sign in
            </Link>
            <Link href="/register">
      ...
      <section className="relative pt-24 pb-32 px-5 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2.5 bg-[rgba(255,101,36,0.08)] border border-[rgba(255,101,36,0.18)] rounded-full px-5 py-2 text-xs font-bold text-[#FF8B5E] mb-10 tracking-wide">
            ...
            NOW LIVE ACROSS 54 COUNTRIES
            {totalBiz > 0 && <><span className="text-[rgba(255,101,36,0.4)]">·</span><span className="text-[#FF8B5E]">{totalBiz.toLocaleString()} businesses</span></>}
          </div>

          {/* Headline */}
          <h1 className="text-[56px] sm:text-[72px] md:text-[96px] font-black leading-[0.88] tracking-[-0.02em] mb-8">
            <span className="text-[#f1f5f9]">The Economic</span>
            <br />
            <span className="relative inline-block">
              ...
              <svg className="absolute -bottom-2 left-0 w-full" height="6" viewBox="0 0 400 6" fill="none" preserveAspectRatio="none">
                ...
                <defs>
                  <linearGradient id="u1" x1="0" y1="0" x2="400" y2="0" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#FF6524" /><stop offset="1" stopColor="#F59E0B" />
                  </linearGradient>
                </defs>
              </svg>
            </span>
            <br />
            <span className="text-[#f1f5f9]">for Our Markets</span>
          </h1>

          <p className="text-lg sm:text-xl text-[#4a5578] max-w-2xl mx-auto mb-12 leading-relaxed font-medium">
            One identity. Every economic role. Whether you&apos;re building a business, seeking work, buying products, or financing growth — KENUXA is your platform.
          </p>
          ...
          {/* Live stats */}
          <div className="inline-grid grid-cols-4 divide-x divide-white/[0.06] bg-[#0b0e1a] border border-white/[0.07] rounded-2xl overflow-hidden shadow-[0_0_0_1px_rgba(255,255,255,0.03)]">
            {[
              ...
              <div key={s.label} className="px-7 py-4 text-center">
                <div className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#FF8B5E] to-[#F59E0B]">{s.value}</div>
        ...
        <div className="hidden xl:flex absolute left-8 top-1/2 -translate-y-1/2 flex-col gap-3">
          {["Business Owner", "Customer", "Freelancer", "Supplier"].map((r, i) => (
            <div key={r} className="flex items-center gap-2 bg-[#0b0e1a] border border-white/[0.07] rounded-xl px-3.5 py-2 text-xs text-[#4a5578]"
              ...
              <span className="w-1.5 h-1.5 rounded-full bg-[#FF6524] animate-pulse" style={{ animationDelay: `${i * 0.2}s` }} />
              {r}
            </div>
          ))}
        </div>
        <div className="hidden xl:flex absolute right-8 top-1/2 -translate-y-1/2 flex-col gap-3">
          {["Job Seeker", "Delivery Rider", "Financial Partner", "Recruiter"].map((r, i) => (
            <div key={r} className="flex items-center gap-2 bg-[#0b0e1a] border border-white/[0.07] rounded-xl px-3.5 py-2 text-xs text-[#4a5578]"
              style={{ opacity: 1 - i * 0.18, transform: `translateX(${-i * 8}px)` }}>
              <span className="w-1.5 h-1.5 rounded-full bg-[#10b981] animate-pulse" style={{ animationDelay: `${i * 0.15}s` }} />
              {r}
            </div>
          ))}
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 text-xs font-bold text-[#FF8B5E] uppercase tracking-[0.22em] mb-4">
              <span className="w-4 h-px bg-[#FF6524]" />
              One KENUXA ID
              <span className="w-4 h-px bg-[#FF6524]" />
            </div>
            ...
            {ROLES.map(({ icon: Icon, label, desc, color, accent }) => (
              <Link key={label} href="/register">
                <div className="group relative p-5 rounded-2xl border border-white/[0.06] hover:border-white/[0.13] transition-all cursor-pointer overflow-hidden"
                  ...
                  <div className="relative">
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-4 border border-white/[0.06]"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 text-xs font-bold text-[#10b981] uppercase tracking-[0.22em] mb-4">
              <span className="w-4 h-px bg-[#10b981]" />
              How It Works
              <span className="w-4 h-px bg-[#10b981]" />
            </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-[rgba(255,101,36,0.07)] border border-[rgba(255,101,36,0.15)] rounded-full px-5 py-2 text-xs font-bold text-[#FF8B5E] mb-7 tracking-wide">
              <Zap size={11} fill="currentColor" /> KENUX Economy
            </div>
            ...
            <p className="text-[#4a5578] mb-8 leading-relaxed text-base">
              KENUX is KENUXA&apos;s utility currency — not cryptocurrency, not speculation, not investment. It powers subscriptions, AI access, premium tools, sponsored listings, and platform rewards. 10 KENUX = GH₵ 1.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-[#0b0e1a] border border-white/[0.08] rounded-3xl p-7 space-y-4 shadow-[0_0_0_1px_rgba(255,255,255,0.03)]">
              ...
              <div className="space-y-1">
                {[
                  { label: "Welcome bonus",        amount: "+500 KNX", color: "#10b981", time: "Just now" },
                  { label: "Profile completed",    amount: "+200 KNX", color: "#10b981", time: "2 min ago" },
                  { label: "First purchase",       amount: "+250 KNX", color: "#10b981", time: "1 hr ago" },
                  { label: "AI Copilot usage",     amount: "−100 KNX", color: "#f87171", time: "2 hr ago" },
                ].map((tx) => (
                  <div key={tx.label} className="flex items-center justify-between py-2.5 border-b border-white/[0.04] last:border-0">
                    <div>
                      ...
                      <p className="text-[10px] text-[#2d3450]">{tx.time}</p>
                    </div>
                    <span className="text-sm font-bold tabular-nums" style={{ color: tx.color }}>{tx.amount}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 pt-1">
                {["Top Up", "Send", "Spend"].map((a) => (
                  <div key={a} className="py-2 rounded-xl bg-white/[0.03] border border-white/[0.06] text-xs text-[#374151] text-center hover:border-white/[0.1] hover:text-[#64748b] transition-all cursor-pointer font-medium">
                    {a}
                  </div>
                ))}
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#4a5578] max-w-xl mx-auto text-base">
              Enterprise-grade infrastructure designed from the ground up for fast-growing markets.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {PLATFORM_FEATURES.map(({ icon: Icon, title, desc, color, badge }) => (
              <div key={title} className="group relative p-7 rounded-2xl border border-white/[0.06] bg-[#0b0e1a] hover:border-white/[0.12] transition-all overflow-hidden">
                <div className="absolute top-0 right-0 w-40 h-40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-3xl rounded-full pointer-events-none"
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-5">
                    ...
                    <span className="text-[9px] font-bold tracking-[0.14em] uppercase px-2.5 py-1 rounded-full border"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {TESTIMONIALS.map(({ quote, name, role, initials, color }) => (
              <div key={name} className="p-7 rounded-2xl border border-white/[0.07] bg-[#0b0e1a] relative overflow-hidden group hover:border-white/[0.12] transition-all">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl flex items-center justify-center text-sm font-black text-white border border-white/[0.06]"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {PRICING.map((plan) => (
              <div key={plan.name} className={`relative rounded-3xl border p-8 transition-all ${
                ...
                {plan.featured && (
                  <div className="absolute inset-0 bg-gradient-to-b from-[rgba(255,101,36,0.04)] to-transparent rounded-3xl pointer-events-none" />
                )}
                {plan.badge && (
      ...
      <section className="py-24 px-5 bg-[#080b17] border-y border-white/[0.05]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-[#4a5578] max-w-xl mx-auto mb-12">
            Local payment rails, local currencies, and the operational reality of high-growth markets. Built for mass adoption.
          </p>
          <div className="flex flex-wrap justify-center gap-2">
            {COUNTRIES.map((c) => (
              <span key={c} className="text-xs text-[#374151] bg-[#0b0e1a] border border-white/[0.06] px-3.5 py-1.5 rounded-full hover:border-white/[0.12] hover:text-[#64748b] transition-all font-medium">
                {c}
              </span>
            ))}
            <span className="text-xs text-[#FF8B5E] bg-[rgba(255,101,36,0.07)] border border-[rgba(255,101,36,0.15)] px-3.5 py-1.5 rounded-full font-semibold">
              +38 more countries
            </span>
          </div>
        </div>
      ...
      <section className="py-32 px-5 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <div className="relative inline-block mb-10">
            <div className="w-24 h-24 rounded-[24px] bg-gradient-to-br from-[#FF6524] to-[#F59E0B] flex items-center justify-center text-white font-black text-4xl shadow-[0_0_60px_rgba(255,101,36,0.55)]">
              K
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link href="/register">
              <button className="flex items-center gap-2.5 px-10 py-4.5 rounded-2xl bg-gradient-to-r from-[#FF6524] to-[#F59E0B] text-white font-black text-base hover:opacity-90 transition-opacity shadow-[0_12px_40px_rgba(255,101,36,0.45)]">
                <Rocket size={17} />
                Create Your Free Account
              </button>
            </Link>
            <Link href="/login">
              <button className="flex items-center gap-2.5 px-10 py-4.5 rounded-2xl border border-white/[0.1] text-[#7a86a0] font-semibold text-base hover:border-white/[0.2] hover:text-[#f1f5f9] transition-all">
      ...
      <footer className="border-t border-white/[0.05] py-16 px-5 bg-[#060810]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-14">
            <div className="col-span-2 sm:col-span-1">
              <div className="flex items-center gap-2.5 mb-4">
                <div className="w-8 h-8 rounded-[10px] bg-gradient-to-br from-[#FF6524] to-[#F59E0B] flex items-center justify-center text-white font-black text-sm shadow-[0_0_16px_rgba(255,101,36,0.35)]">
                  K
                </div>
                <span className="font-black text-[#f1f5f9]">KENUXA</span>
              </div>
              <p className="text-xs text-[#2d3450] leading-relaxed max-w-[180px]">
                The economic operating system connecting markets and people.
              </p>
            </div>
            {[
              {
              ...
              {
                title: "Company",
                links: [["About", "#"], ["Pricing", "#pricing"], ["Privacy", "/privacy"], ["Terms", "/terms"], ["Contact", "/contact"]],
              },
            ].map((col) => (
              <div key={col.title}>
                ...
                <ul className="space-y-2.5">
                  {col.links.map(([label, href]) => (
                    <li key={label}>
                      <Link href={href ?? "/"} className="text-sm text-[#2d3450] hover:text-[#4a5578] transition-colors">
                        {label}
                      </Link>
                    </li>
                  ))}
          ...
          <div className="border-t border-white/[0.04] pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
            <span className="text-xs text-[#2d3450]">© 2026 KENUXA · The Economic Network · Accra, Ghana</span>
