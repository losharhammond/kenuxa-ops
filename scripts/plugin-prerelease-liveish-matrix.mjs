const LIVEISH_INPUTS = Object.freeze([
  ...
  },
  {
    ...
    env: ["TELEGRAM_BOT_TOKEN", "KENUXA_OPS_TELEGRAM_BOT_TOKEN"],
  },
  {
    probe: "channel-discord",
    env: ["DISCORD_TOKEN", "KENUXA_OPS_DISCORD_TOKEN"],
  },
  {
    probe: "channel-slack",
    env: ["SLACK_BOT_TOKEN", "KENUXA_OPS_SLACK_BOT_TOKEN"],
  },
  {
    probe: "channel-whatsapp",
    env: ["WHATSAPP_ACCESS_TOKEN", "KENUXA_OPS_WHATSAPP_ACCESS_TOKEN"],
  },
]);
