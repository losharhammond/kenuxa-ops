...
const pluginRecordSnapshot = () => {
  const config = readJson(KenuxaOpsPath("KENUXA OPS.json"));
...
function seedInstallState() {
  writeJson(KenuxaOpsPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.KENUXA_OPS_CONFIG_PATH, { plugins: {} });
  writeJson(KenuxaOpsPath("plugins", "installs.json"), {
    version: 1,
