...
const pluginRecordSnapshot = () => {
  const config = readJson(KENUXA OPSPath("KENUXA OPS.json"));
...
function seedInstallState() {
  writeJson(KENUXA OPSPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.KENUXA OPS_CONFIG_PATH, { plugins: {} });
  writeJson(KENUXA OPSPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by KENUXA OPS plugin registry commands.",
    ...
    installRecords: {
      "lossless-claw": {
        ...
        installPath: "~/.KENUXA OPS/extensions/lossless-claw",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("KENUXA OPS will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  for (const expected of [
    ...
    "Run KENUXA OPS doctor --fix to attempt automatic repair.",
    `Run KENUXA OPS plugins inspect ${pluginId} --runtime --json for details.`,
  ]) {
