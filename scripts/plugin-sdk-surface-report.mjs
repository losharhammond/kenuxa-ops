...
const budgets = {
  publicEntrypoints: Number(process.env.KENUXA_OPS_PLUGIN_SDK_MAX_PUBLIC_ENTRYPOINTS ?? 303),
  publicExports: Number(process.env.KENUXA_OPS_PLUGIN_SDK_MAX_PUBLIC_EXPORTS ?? 8449),
  publicFunctionExports: Number(
    process.env.KENUXA_OPS_PLUGIN_SDK_MAX_PUBLIC_FUNCTION_EXPORTS ?? 4656,
  ),
  publicDeprecatedExports: Number(
    process.env.KENUXA_OPS_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS ?? 2800,
  ),
  publicWildcardReexports: Number(
    process.env.KENUXA_OPS_PLUGIN_SDK_MAX_PUBLIC_WILDCARD_REEXPORTS ?? 207,
  ),
};
