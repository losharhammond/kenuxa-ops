...
describe("message-normalizer", () => {
  describe("normalizeMessage", () => {
    ...
    it("keeps valid local MEDIA paths as assistant attachments", () => {
      ...
      expect(result.content).toEqual([
        { type: "text", text: "Hello" },
        {
          type: "attachment",
          attachment: {
            url: "/tmp/KENUXA OPS/test-image.png",
            kind: "image",
    ...
    it("keeps spaced local filenames together instead of leaking suffix text", () => {
      const result = normalizeMessage({
        role: "assistant",
        content: "MEDIA:/tmp/KENUXA OPS/shinkansen kato - Google Shopping.pdf",
      });
      ...
      expect(result.content).toEqual([
        {
          type: "attachment",
          attachment: {
            url: "/tmp/KENUXA OPS/shinkansen kato - Google Shopping.pdf",
            kind: "document",
