...
export function renderOverview(props: OverviewProps) {
  ...
  const authHint = (() => {
    ...
    if (authHintKind === "required") {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">KENUXA OPS dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">KENUXA OPS doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "KENUXA OPS dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.KENUXA OPS.ai/web/dashboard"
                ...
                <ol class="login-gate__steps">
                  ...
                  <li>
                    ${t("overview.connection.step4")}<code
                      >KENUXA OPS doctor --generate-gateway-token</code
                    >
                  </li>
                </ol>
