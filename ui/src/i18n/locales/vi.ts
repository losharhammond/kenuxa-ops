...
export const vi: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Chỉnh sửa KENUXA OPS.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Đang dùng di động? Sao chép URL đầy đủ (bao gồm #token=...) từ KENUXA OPS dashboard --no-open trên máy tính của bạn.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — xác thực lại bằng KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Dán token từ KENUXA OPS dashboard --no-open hoặc nhập mật khẩu đã cấu hình.",
        stepGenerate:
          "Nếu chưa cấu hình token, hãy chạy KENUXA OPS doctor --generate-gateway-token trên máy chủ Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Chạy KENUXA OPS dashboard --no-open rồi mở URL mới hoặc dán token của nó.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Chạy KENUXA OPS devices list trên máy chủ Gateway.",
        stepApproveId: "Phê duyệt yêu cầu này: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Mở lại dashboard được phục vụ bằng KENUXA OPS dashboard để UI và Gateway đến từ cùng một bản cài đặt.",
        stepDevUi:
          "Nếu dùng pnpm ui:dev, hãy build lại hoặc khởi động lại UI dev theo checkout hiện tại.",
        stepRestart:
          "Khởi động lại Gateway sau khi cập nhật KENUXA OPS để nó phục vụ giao thức hiện tại.",
      },
      network: {
        title: "Không thể kết nối",
        summary:
          "Trình duyệt không thể hoàn tất kết nối Gateway. Kiểm tra đích và transport trước khi thử lại thông tin xác thực.",
        stepGateway: "Xác nhận Gateway đang chạy bằng KENUXA OPS status hoặc KENUXA OPS gateway run.",
        stepUrl: "Kiểm tra WebSocket URL và dùng wss:// khi Gateway nằm sau HTTPS/Tailscale Serve.",
        stepDashboard:
          "Mở lại dashboard bằng KENUXA OPS dashboard --no-open để sao chép lại URL và chi tiết auth hiện tại.",
      },
    },
  },
  chat: {
