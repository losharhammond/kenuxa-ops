...
export const nl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Op mobiel? Kopieer de volledige URL (inclusief #token=...) vanuit KENUXA OPS dashboard --no-open op je desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — authenticeer opnieuw met KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Plak het token uit KENUXA OPS dashboard --no-open of voer het geconfigureerde wachtwoord in.",
        stepGenerate:
          "Als er geen token is geconfigureerd, voer dan KENUXA OPS doctor --generate-gateway-token uit op de Gateway-host.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Voer KENUXA OPS dashboard --no-open uit en open de nieuwe URL of plak het token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Voer KENUXA OPS devices list uit op de Gateway-host.",
        stepApproveId: "Keur deze aanvraag goed: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Open het geserveerde dashboard opnieuw met KENUXA OPS dashboard zodat UI en Gateway uit dezelfde installatie komen.",
        stepDevUi:
          "Als je pnpm ui:dev gebruikt, bouw of herstart de dev-UI tegen de huidige checkout.",
        stepRestart:
          "Herstart de Gateway na het bijwerken van KENUXA OPS zodat het huidige protocol wordt geserveerd.",
      },
      network: {
        ...
        stepGateway: "Bevestig dat de Gateway draait met KENUXA OPS status of KENUXA OPS gateway run.",
        stepUrl:
          "Controleer de WebSocket-URL en gebruik wss:// wanneer de Gateway achter HTTPS/Tailscale Serve staat.",
        stepDashboard:
          "Open het dashboard opnieuw met KENUXA OPS dashboard --no-open om de huidige URL en authdetails opnieuw te kopiëren.",
      },
    },
  },
  chat: {
