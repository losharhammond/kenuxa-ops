...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Modifier KENUXA OPS.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Sur mobile ? Copiez l’URL complète (y compris #token=...) depuis KENUXA OPS dashboard --no-open sur votre ordinateur.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — réauthentifiez-vous avec KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Collez le jeton de KENUXA OPS dashboard --no-open ou saisissez le mot de passe configuré.",
        stepGenerate:
          "Si aucun jeton n’est configuré, exécutez KENUXA OPS doctor --generate-gateway-token sur l’hôte Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Exécutez KENUXA OPS dashboard --no-open et ouvrez la nouvelle URL ou collez son jeton.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Exécutez KENUXA OPS devices list sur l’hôte Gateway.",
        stepApproveId: "Approuvez cette demande : KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Rouvrez le dashboard servi avec KENUXA OPS dashboard afin que l’UI et le Gateway viennent de la même installation.",
        stepDevUi:
          "Si vous utilisez pnpm ui:dev, reconstruisez ou redémarrez l’UI de développement avec le checkout actuel.",
        stepRestart:
          "Redémarrez le Gateway après la mise à jour d’KENUXA OPS afin qu’il serve le protocole actuel.",
      },
      network: {
        ...
        stepGateway:
          "Confirmez que le Gateway fonctionne avec KENUXA OPS status ou KENUXA OPS gateway run.",
        stepUrl:
          "Vérifiez l’URL WebSocket et utilisez wss:// lorsque le Gateway est derrière HTTPS/Tailscale Serve.",
        stepDashboard:
          "Rouvrez le dashboard avec KENUXA OPS dashboard --no-open pour recopier l’URL actuelle et les détails d’authentification.",
      },
    },
  },
  chat: {
