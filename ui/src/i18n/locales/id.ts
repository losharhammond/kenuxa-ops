...
export const id: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Di seluler? Salin URL lengkap (termasuk #token=...) dari KENUXA OPS dashboard --no-open di desktop Anda.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — autentikasi ulang dengan KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Tempel token dari KENUXA OPS dashboard --no-open atau masukkan kata sandi yang dikonfigurasi.",
        stepGenerate:
          "Jika belum ada token yang dikonfigurasi, jalankan KENUXA OPS doctor --generate-gateway-token di host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Jalankan KENUXA OPS dashboard --no-open lalu buka URL baru atau tempel tokennya.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Jalankan KENUXA OPS devices list di host Gateway.",
        stepApproveId: "Setujui permintaan ini: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Buka kembali dashboard yang disajikan dengan KENUXA OPS dashboard agar UI dan Gateway berasal dari instalasi yang sama.",
        stepDevUi:
          "Jika menggunakan pnpm ui:dev, bangun ulang atau mulai ulang UI dev terhadap checkout saat ini.",
        stepRestart:
          "Mulai ulang Gateway setelah memperbarui KENUXA OPS agar menyajikan protokol saat ini.",
      },
      network: {
        ...
        stepGateway: "Pastikan Gateway berjalan dengan KENUXA OPS status atau KENUXA OPS gateway run.",
        stepUrl:
          "Periksa URL WebSocket dan gunakan wss:// saat Gateway berada di belakang HTTPS/Tailscale Serve.",
        stepDashboard:
          "Buka kembali dashboard dengan KENUXA OPS dashboard --no-open untuk menyalin ulang URL dan detail auth saat ini.",
      },
    },
  },
  chat: {
