...
export const ar: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "على الهاتف؟ انسخ عنوان URL الكامل (بما في ذلك #token=...) من KENUXA OPS dashboard --no-open على سطح المكتب.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — أعد المصادقة باستخدام KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "الصق الرمز المميز من KENUXA OPS dashboard --no-open أو أدخل كلمة المرور المكونة.",
        stepGenerate:
          "إذا لم يتم تكوين رمز مميز، فشغل KENUXA OPS doctor --generate-gateway-token على مضيف Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "شغل KENUXA OPS dashboard --no-open وافتح عنوان URL الجديد أو الصق رمزه المميز.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "شغل KENUXA OPS devices list على مضيف Gateway.",
        stepApproveId: "وافق على هذا الطلب: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "أعد فتح لوحة المعلومات المقدمة باستخدام KENUXA OPS dashboard حتى يأتي UI وGateway من التثبيت نفسه.",
        stepDevUi:
          "إذا كنت تستخدم pnpm ui:dev، فأعد بناء أو تشغيل واجهة التطوير مقابل checkout الحالي.",
        stepRestart: "أعد تشغيل Gateway بعد تحديث KENUXA OPS حتى يقدم البروتوكول الحالي.",
      },
      network: {
        title: "تعذر الاتصال",
        summary:
          "لم يتمكن المتصفح من إكمال اتصال Gateway. تحقق من الهدف والنقل قبل إعادة تجربة بيانات الاعتماد.",
        stepGateway: "تأكد من أن Gateway يعمل باستخدام KENUXA OPS status أو KENUXA OPS gateway run.",
        stepUrl:
          "تحقق من عنوان WebSocket واستخدم wss:// عندما يكون Gateway خلف HTTPS/Tailscale Serve.",
        stepDashboard:
          "أعد فتح لوحة المعلومات باستخدام KENUXA OPS dashboard --no-open لنسخ عنوان URL وتفاصيل المصادقة الحالية.",
      },
    },
  },
  chat: {
