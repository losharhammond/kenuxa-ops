...
export const pl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Na urządzeniu mobilnym? Skopiuj pełny URL (w tym #token=...) z KENUXA OPS dashboard --no-open na komputerze.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — uwierzytelnij ponownie za pomocą KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Wklej token z KENUXA OPS dashboard --no-open albo wpisz skonfigurowane hasło.",
        stepGenerate:
          "Jeśli token nie jest skonfigurowany, uruchom KENUXA OPS doctor --generate-gateway-token na hoście Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Uruchom KENUXA OPS dashboard --no-open i otwórz świeży URL albo wklej jego token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Uruchom KENUXA OPS devices list na hoście Gateway.",
        stepApproveId: "Zatwierdź to żądanie: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Otwórz ponownie udostępniany dashboard poleceniem KENUXA OPS dashboard, aby UI i Gateway pochodziły z tej samej instalacji.",
        stepDevUi:
          "Jeśli używasz pnpm ui:dev, przebuduj lub uruchom ponownie UI dev względem bieżącego checkoutu.",
        stepRestart:
          "Zrestartuj Gateway po aktualizacji KENUXA OPS, aby udostępniał bieżący protokół.",
      },
      network: {
        ...
        stepGateway:
          "Potwierdź, że Gateway działa, używając KENUXA OPS status lub KENUXA OPS gateway run.",
        stepUrl: "Sprawdź URL WebSocket i użyj wss://, gdy Gateway jest za HTTPS/Tailscale Serve.",
        stepDashboard:
          "Otwórz ponownie dashboard przez KENUXA OPS dashboard --no-open, aby skopiować bieżący URL i szczegóły auth.",
      },
    },
  },
  chat: {
