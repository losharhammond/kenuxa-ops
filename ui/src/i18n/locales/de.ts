...
export const de: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von KENUXA OPS dashboard --no-open auf Ihrem Desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — mit KENUXA OPS models auth erneut authentifizieren",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Füge das Token aus KENUXA OPS dashboard --no-open ein oder gib das konfigurierte Passwort ein.",
        stepGenerate:
          "Wenn kein Token konfiguriert ist, führe KENUXA OPS doctor --generate-gateway-token auf dem Gateway-Host aus.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Führe KENUXA OPS dashboard --no-open aus und öffne die frische URL oder füge ihr Token ein.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Führe KENUXA OPS devices list auf dem Gateway-Host aus.",
        stepApproveId: "Genehmige diese Anfrage: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Öffne das bereitgestellte Dashboard mit KENUXA OPS dashboard erneut, damit UI und Gateway aus derselben Installation stammen.",
        stepDevUi:
          "Wenn du pnpm ui:dev verwendest, baue oder starte die Dev-UI gegen den aktuellen Checkout neu.",
        stepRestart:
          "Starte das Gateway nach dem Aktualisieren von KENUXA OPS neu, damit es das aktuelle Protokoll bereitstellt.",
      },
      network: {
        ...
        stepGateway:
          "Bestätige mit KENUXA OPS status oder KENUXA OPS gateway run, dass das Gateway läuft.",
        stepUrl:
          "Prüfe die WebSocket-URL und verwende wss://, wenn das Gateway hinter HTTPS/Tailscale Serve liegt.",
        stepDashboard:
          "Öffne das Dashboard mit KENUXA OPS dashboard --no-open erneut, um die aktuelle URL und Auth-Details zu kopieren.",
      },
    },
  },
  chat: {
