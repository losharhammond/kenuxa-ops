...
export const pt_BR: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando KENUXA OPS dashboard --no-open no desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — autentique novamente com KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Cole o token de KENUXA OPS dashboard --no-open ou informe a senha configurada.",
        stepGenerate:
          "Se nenhum token estiver configurado, execute KENUXA OPS doctor --generate-gateway-token no host do Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Execute KENUXA OPS dashboard --no-open e abra o novo URL ou cole seu token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Execute KENUXA OPS devices list no host do Gateway.",
        stepApproveId: "Aprove esta solicitação: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reabra o dashboard servido com KENUXA OPS dashboard para que UI e Gateway venham da mesma instalação.",
        stepDevUi:
          "Se estiver usando pnpm ui:dev, reconstrua ou reinicie a UI de desenvolvimento com o checkout atual.",
        stepRestart:
          "Reinicie o Gateway depois de atualizar o KENUXA OPS para que ele sirva o protocolo atual.",
      },
      network: {
        ...
        stepGateway:
          "Confirme que o Gateway está em execução com KENUXA OPS status ou KENUXA OPS gateway run.",
        stepUrl:
          "Verifique o URL de WebSocket e use wss:// quando o Gateway estiver atrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reabra o dashboard com KENUXA OPS dashboard --no-open para copiar novamente o URL atual e os detalhes de auth.",
      },
    },
  },
  chat: {
