...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "KENUXA OPS.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde KENUXA OPS dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — KENUXA OPS models auth ile yeniden kimlik doğrulayın",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "KENUXA OPS dashboard --no-open çıktısındaki tokenı yapıştırın veya yapılandırılmış parolayı girin.",
        stepGenerate:
          "Token yapılandırılmamışsa Gateway ana makinesinde KENUXA OPS doctor --generate-gateway-token çalıştırın.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "KENUXA OPS dashboard --no-open çalıştırın ve yeni URL’yi açın veya tokenını yapıştırın.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Gateway hostunda KENUXA OPS devices list çalıştırın.",
        stepApproveId: "Bu isteği onaylayın: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "UI ve Gateway aynı kurulumdan gelsin diye sunulan dashboardı KENUXA OPS dashboard ile yeniden açın.",
        stepDevUi:
          "pnpm ui:dev kullanıyorsanız geliştirme UI’sini mevcut checkouta göre yeniden derleyin veya yeniden başlatın.",
        stepRestart:
          "KENUXA OPS güncellemesinden sonra Gateway’i yeniden başlatın, böylece güncel protokolü sunsun.",
      },
      network: {
        title: "Bağlanılamadı",
        summary:
        ...
        stepGateway:
          "KENUXA OPS status veya KENUXA OPS gateway run ile Gateway’in çalıştığını doğrulayın.",
        stepUrl:
          "WebSocket URL’sini kontrol edin ve Gateway HTTPS/Tailscale Serve arkasındaysa wss:// kullanın.",
        stepDashboard:
          "Geçerli URL ve auth ayrıntılarını yeniden kopyalamak için dashboardı KENUXA OPS dashboard --no-open ile yeniden açın.",
      },
    },
  },
  chat: {
