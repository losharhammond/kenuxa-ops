...
export const it: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Modifica KENUXA OPS.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Su mobile? Copia l'URL completo (incluso #token=...) da KENUXA OPS dashboard --no-open sul desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — riautenticati con KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Incolla il token da KENUXA OPS dashboard --no-open oppure inserisci la password configurata.",
        stepGenerate:
          "Se non è configurato alcun token, esegui KENUXA OPS doctor --generate-gateway-token sull’host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Esegui KENUXA OPS dashboard --no-open e apri il nuovo URL oppure incolla il suo token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Esegui KENUXA OPS devices list sull’host Gateway.",
        stepApproveId: "Approva questa richiesta: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Riapri il dashboard servito con KENUXA OPS dashboard in modo che UI e Gateway provengano dalla stessa installazione.",
        stepDevUi:
          "Se usi pnpm ui:dev, ricompila o riavvia la UI di sviluppo contro il checkout corrente.",
        stepRestart:
          "Riavvia il Gateway dopo aver aggiornato KENUXA OPS affinché serva il protocollo corrente.",
      },
      network: {
        ...
        stepGateway:
          "Conferma che il Gateway sia in esecuzione con KENUXA OPS status o KENUXA OPS gateway run.",
        stepUrl:
          "Controlla l’URL WebSocket e usa wss:// quando il Gateway è dietro HTTPS/Tailscale Serve.",
        stepDashboard:
          "Riapri il dashboard con KENUXA OPS dashboard --no-open per ricopiare l’URL corrente e i dettagli auth.",
      },
    },
  },
  chat: {
