...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from KENUXA OPS dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      pairing: {
        ...
        stepList: "Run KENUXA OPS devices list on the Gateway host.",
        stepApproveId: "Approve this request: KENUXA OPS devices approve {requestId}.",
      ...
      network: {
        ...
        stepGateway: "Confirm the Gateway is running with KENUXA OPS status or KENUXA OPS gateway run.",
        stepUrl:
