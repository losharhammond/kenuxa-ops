...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Редагування KENUXA OPS.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "На мобільному? Скопіюйте повний URL (включно з #token=...) з KENUXA OPS dashboard --no-open на вашому комп’ютері.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — повторно виконайте авторизацію через KENUXA OPS models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Вставте токен з KENUXA OPS dashboard --no-open або введіть налаштований пароль.",
        stepGenerate:
          "Якщо токен не налаштовано, виконайте KENUXA OPS doctor --generate-gateway-token на хості Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Виконайте KENUXA OPS dashboard --no-open і відкрийте свіжий URL або вставте його токен.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Виконайте KENUXA OPS devices list на хості Gateway.",
        stepApproveId: "Схваліть цей запит: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Знову відкрийте наданий dashboard через KENUXA OPS dashboard, щоб UI і Gateway походили з однієї інсталяції.",
        stepDevUi:
          "Якщо використовуєте pnpm ui:dev, перебудуйте або перезапустіть dev UI з поточного checkout.",
        stepRestart:
          "Перезапустіть Gateway після оновлення KENUXA OPS, щоб він надавав поточний протокол.",
      },
      network: {
        ...
        stepGateway:
          "Підтвердьте, що Gateway працює, через KENUXA OPS status або KENUXA OPS gateway run.",
        stepUrl:
          "Перевірте WebSocket URL і використовуйте wss://, коли Gateway знаходиться за HTTPS/Tailscale Serve.",
        stepDashboard:
          "Знову відкрийте dashboard через KENUXA OPS dashboard --no-open, щоб повторно скопіювати поточний URL і деталі auth.",
      },
    },
  },
  chat: {
