...
export const fa: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "روی موبایل هستید؟ URL کامل (شامل #token=...) را از KENUXA OPS dashboard --no-open روی دسکتاپ خود کپی کنید.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — با KENUXA OPS models auth دوباره احراز هویت کنید",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "توکن KENUXA OPS dashboard --no-open را جای گذاری کنید یا گذرواژه پیکربندی شده را وارد کنید.",
        stepGenerate:
          "اگر توکنی پیکربندی نشده است، KENUXA OPS doctor --generate-gateway-token را روی میزبان Gateway اجرا کنید.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "KENUXA OPS dashboard --no-open را اجرا کنید و URL تازه را باز کنید یا توکن آن را جای گذاری کنید.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "KENUXA OPS devices list را روی میزبان Gateway اجرا کنید.",
        stepApproveId: "این درخواست را تأیید کنید: KENUXA OPS devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "داشبورد سرو شده را با KENUXA OPS dashboard دوباره باز کنید تا UI و Gateway از همان نصب باشند.",
        stepDevUi:
          "اگر از pnpm ui:dev استفاده می کنید، UI توسعه را بر اساس checkout فعلی دوباره بسازید یا راه اندازی کنید.",
        stepRestart:
          "پس از به روزرسانی KENUXA OPS، Gateway را دوباره راه اندازی کنید تا پروتکل فعلی را سرو کند.",
      },
      network: {
        ...
        stepGateway:
          "با KENUXA OPS status یا KENUXA OPS gateway run تأیید کنید که Gateway در حال اجرا است.",
        stepUrl:
          "URL WebSocket را بررسی کنید و وقتی Gateway پشت HTTPS/Tailscale Serve است از wss:// استفاده کنید.",
        stepDashboard:
          "داشبورد را با KENUXA OPS dashboard --no-open دوباره باز کنید تا URL و جزئیات احراز هویت فعلی را دوباره کپی کنید.",
      },
    },
  },
  chat: {
